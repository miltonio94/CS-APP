...
** 1.7.4 Files
Files are a sequence of bytes. Every I/O operation are modelled as a file. We can access input and output by reading and writting files using a set of system calls known as /Unix I/O/.
